...
<head>
  ...
  <title><?php echo $title; ?> | BMS</title>
</head>
<body>
            ...
            <div class="mbr-table">
                <div class="mbr-table-cell">
                    ...
                    <div class="navbar-brand">
                        <a href="#top" class="navbar-logo"><img src="<?php echo Uri::base(false);?>/assets/landing-theme/images/logo.jpeg" alt="SmartFarmer" title="SmartFarmer logo"></a>
                    </div>
...
<section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background mbr-after-navbar" id="header1-1" style="background-image: url(<?php echo Uri::base(false);?>/assets/landing-theme/images/bg.jpeg);">
