					...
					<?php foreach ($branches as $item): ?>	
						...
						<tr>
							...
							<div class="btn-toolbar">
								<div class="btn-group">
								<button type="button" class="btn btn-info btn-small" onclick="pickBranch('<?php echo $item->first_name; ?>','<?php echo $item->user_id ; ?>')"> Pick
									</button>
								</div>
								</div>
...
<script>
	function pickBranch(first_name,userid)
	{
		...
		document.getElementById('user_id_code').value=first_name;
